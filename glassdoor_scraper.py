...
def get_jobs(keyword, num_jobs, verbose,):
    ...
    url = 'https://www.glassdoor.com/Job/us-' +keyword+ '-jobs-SRCH_IL.0,2_IN1_KO3,17.htm'

    #url = 'https://www.glassdoor.com/Job/jobs.htm?sc.generalKeyword=%22"' +keyword+'"%22'
    ...
    while len(jobs) < num_jobs:  # If true, should be still looking for new jobs.
        ...
        try:
            driver.find_element_by_css_selector('[alt="Close"]').click()  # clicking to the X. #Sign up page cancel
        ...
        for job_button in job_buttons:
            ...
            try:
                salary_estimate = driver.find_element_by_xpath('.//span[@class="gray salary"]').text #retrives salary
            ...
            try:
                driver.find_element_by_css_selector('[alt="Close"]').click()  # clicking to the X. #Estimated salary pop up cancel
